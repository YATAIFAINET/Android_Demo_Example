package center.language.elite.chilee_demo.Main_File.Favo;
...
public class Main_Favorite extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.Main_Money_Lin:
                ...
                Log.d(mGCMD.TAG,"Main_Product_Lin");
                break;
